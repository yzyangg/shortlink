...
import static com.nageoffer.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_WRITE_READ_LOCK_KEY;
...
public class ShortLinkRabbitConsumer {
    ...
    public void actualSaveShortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        Optional.ofNullable(gid).orElseThrow(() -> new ServiceException("GID不能为空"));
        fullShortUrl = Optional.ofNullable(fullShortUrl).orElse(statsRecord.getFullShortUrl());
        RLock wLock = Redisson.create().getReadWriteLock(SHORT_LINK_WRITE_READ_LOCK_KEY).writeLock();
        wLock.lock();
        try {
